...
int main()
{
    ...
    ele deve reconhecer as regras de pontua��o*/
     ...
     printf("BEM VINDO AO SISTEMA DE SOMA DE NUMEROS NATURAIS !!!");
     ...
     printf("OBS:.VOCE SO PODE INSERIR DOIS NUMEROS PARA ESTA OPERACAO");
     ...
     printf("O Valor da soma e igual: %d \a", Soma);
     ...
     {
          printf("O valor de sua soma e maior que 10\a");
     }
     else
     /* caso n�o for aquilo que era para ser o sistema vai mostra outra mensagem referente ao caso */
     {
          printf("O valor de sua soma e menor ou igual a 10\a ");
     }
